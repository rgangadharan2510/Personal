...
class SessionClient:
    ...
    def get_session_client(self, account_number) -> Session:
        """
        ...
        assume_role_response = sts_client.assume_role(
            RoleArn=f'arn:aws:iam::{account_number}:role/hsarch-IamAccessKeyRotator-ExecutionRole',
            RoleSessionName='hsarch-IamAccessKeyRotator-ExecutionRole1',
            DurationSeconds=900
        )
